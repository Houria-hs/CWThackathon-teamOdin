...
import logo from "../assets/clearClauseLogo.png"
    ...
    <div className="min-h-screen flex">
      <div className="w-full  flex justify-center ">
        <div className="w-full max-w-md">
          ...
          <p
           className="text-[#4D4D4D] mb-8 bold-400 text-center text-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex flex-col items-start gap-[12px]">
              <label className="text-sm font-medium text-[#4D4D4D]">Full name</label>
              <input
                type="text"
                name="username"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full h-12 rounded-xl bg-[#0057B8] text-white font-medium hover:opacity-90 transition disabled:opacity-50"
            >
